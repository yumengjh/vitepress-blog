...
export default defineConfig({
    ...
    themeConfig: {
        ...
        // 为每种语言提供对应的文章数据，在组件可以调用获得对应语言的文章数据
        //  const chinesePosts = await theme.value.getPostsForLang('root')()
